...
#define STRING_CONFIG_H_AUTHOR "Creatorpult Ender Bowden V0.1.3" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender3Pro CP-v0.1.3"
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MESH_INSET 44              // Set Mesh bounds as an inset region of the bed
